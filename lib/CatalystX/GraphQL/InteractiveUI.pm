package CatalystX::GraphQL::InteractiveUI;
...
sub accepts_request {
  my ($self, $req) = @_;
  return 1  if (($req->env->{HTTP_ACCEPT}||'') =~ /^text\/html\b/)
...
CatalystX::GraphQL::InteractiveUI - Template and processing for the GraphQL UI
